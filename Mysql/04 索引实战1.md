...
VALUES 
  ('LiLei', 22, 'manager', NOW()); INSERT INTO employees(name, age, position, hire_time) 
VALUES 
  ('HanMeimei', 23, 'dev', NOW()); INSERT INTO employees(name, age, position, hire_time) 
VALUES 
  ('Lucy', 23, 'dev', NOW());
...
![1650246400680](../image/1650246400680.png)
...
![1650246451952](../image/1650246451952.png)
...
![1650246614782](../image/1650246614782.png)
...
![1650246673734](../image/1650246673734.png)

```sql
EXPLAIN SELECT * FROM employees WHERE (name = 'LiLei' or name = 'HanMeimei') AND age = 22 AND position ='manager';         
```

![1650246712975](../image/1650246712975.png)
...
![1650246798225](../image/1650246798225.png)         

```sql
EXPLAIN SELECT * FROM employees_copy WHERE (name = 'LiLei' or name = 'HanMeimei') AND age = 22 AND position ='manager';  
```

![1650246853732](../image/1650246853732.png)
...
![1650246924427](../image/1650246924427.png)         

```sql
EXPLAIN SELECT * FROM employees_copy WHERE name like 'LiLei%' AND age = 22 AND position ='manager';      
```

![1650246945174](../image/1650246945174.png)        
...
![1650247135163](../image/1650247135163.png)
...
![1650247229399](../image/1650247229399.png)

```sql
mysql> EXPLAIN select * from employees where name > 'zzz' ;         
```

![1650247263931](../image/1650247263931.png)
...
![1650247914766](../image/1650247914766.png)
...
![1650248115660](../image/1650248115660.png)
...
![1650248189977](../image/1650248189977.png)
...
![1650248486136](../image/1650248486136.png)
...
![1650248513934](../image/1650248513934.png)
...
![1650248538095](../image/1650248538095.png)
...
![1650248581793](../image/1650248581793.png)
...
![1650248604066](../image/1650248604066.png)

![1650248609240](../image/1650248609240.png)
...
![1650249348655](../image/1650249348655.png)
